...
if __name__ == "__main__":
    print(
        ...
        "\n"
        "Note: you must supply a 'robot' implementing:\n"
        "  - forward_kinematics(q, s) -> (4,4) SE(3) matrix\n"
        "  - forward_kinematics_tendons(q, s) -> (n_actuators, 3)\n"
        "  - attributes: L (per-segment lengths), r (per-segment radii)\n"
        "\n"
        "Controls:\n"
        "  Space: play/pause\n"
        "  ←/→  : next/prev frame\n"
